  ...
  <center>
    ...
    <header style="background-color: yellow;">
      ...
      <div class="na2">
        <ul class="nav nav-tabs">
          ...
          <li class="nav-item">
            <h3><b><a class="nav-link" href="/guitar.kalimba">About Us</a></b></h3>
          </li>
          <li class="nav-item">
    ...
    <div class="paralell">
      ...
      <div class="vertical-menu">
        ...
        <a href="/guitar/ukelele"> <img weight="50px" height="50px" src="https://cdn.shopify.com/s/files/1/1434/2352/products/Freshman-Ukulele-Soprano-Solid-Top-Mahogany-FU1S-with-gig-bag_2048x@2x.jpg?v=1477738660" alt="Vit guitar shop">Ukulele</a>
        ...
        <div id="id">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-4">
                        <div class="thumbnail">
                            <img class="group list-group-image" src="{{'/storage/'.$guitar->image}}" alt="Card image cap">
                            <center>
                                <div class="caption">
                                    <h5 class="card-title"> {{ $guitar->name}} </h5>
                                    <p class="card-text"> <span>{{ $guitar->old_price }}.000.000 $ </span> </p>

                                    <div class="row">
                                        <div class="col-xs-6  col-md-6">
                                            <form action="/guitar/cart/{{$guitar->id}}">
